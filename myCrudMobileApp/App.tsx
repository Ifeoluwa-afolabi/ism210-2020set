...
const App: React.FC = () => {
 ...
 //We need to hold the dataSource once opened, so we can pass it to componentsfor connection.
 ...
 getDataSource(); //to be called only once.
  ...
  //Prepare our conditional display. What we display will depend on whether dataSource is npavailable or not
const display = () => {
if (dataSource) {
return (
<>
